...
public class AppListRecyclerViewAdapter
        extends RecyclerView.Adapter<AppListRecyclerViewAdapter.ViewHolder> {
...
//            mValues = items;
//        }
    public AppListRecyclerViewAdapter(Context context, ArrayList<Object> items) {
        context.getTheme().resolveAttribute(R.attr.selectableItemBackground, mTypedValue, true);
        mBackground = mTypedValue.resourceId;
        mValues = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final AppListBean appbean = (AppListBean) mValues.get(position);
/*
