 ...
 */
public class CashBackRecyclerViewAdapter extends RecyclerView.Adapter<CashBackRecyclerViewAdapter.ViewHolder> {
...
//            mValues = items;
//        }
    public CashBackRecyclerViewAdapter(Context context, ArrayList<Object> items) {
        context.getTheme().resolveAttribute(R.attr.selectableItemBackground, mTypedValue, true);
        mBackground = mTypedValue.resourceId;
        mValues = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final CashBackListBean appbean = (CashBackListBean) mValues.get(position);
/*
