 ...
 */
public class DoTaskRecyclerViewAdapter extends RecyclerView.Adapter<DoTaskRecyclerViewAdapter.ViewHolder> {
...
//            mValues = items;
//        }
    public DoTaskRecyclerViewAdapter(Context context, ArrayList<Object> items) {
        context.getTheme().resolveAttribute(R.attr.selectableItemBackground, mTypedValue, true);
        mBackground = mTypedValue.resourceId;
        mValues = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final DoTaskListBean appbean = (DoTaskListBean) mValues.get(position);
/*
